<template>
      <div v-if="user.loggedIn">
        <v-card class="pa-md-4 mt-5 mx-lg-auto" color="gray" width="800px">

              <template v-slot:title>
                 <h1 align="center">QUIZ APP:</h1> 
              </template>
              <h3 align="center" class="font-weight-light">Science: Computers</h3>
        ...
        <v-btn :disabled="!start" @click="load(0)" :loading="loadingbtn[0]"  tile dark class="text-light-green mt-8" variant="outlined">
          START QUIZ
        </v-btn>
              ...
              <v-container justify="center">
                  <v-row dense>
                              ...
                              <v-row no-gutters justify="center" style="text-align:center">
                                  <v-col>
                                      <v-sheet class="pa-2 ma-2">
                                          <h3 class="font-weight-light">Score: <strong>{{ correctAnswers }}</strong></h3>
                                      </v-sheet>
                                  </v-col>
                                  <v-col>
                                      <v-sheet class="pa-2 ma-2">
                                          <h3 class="font-weight-light">Question: <br><strong>{{ index + 1 }} of {{ questions.length
                                          }}</strong></h3>
                                      </v-sheet>
                                  </v-col>
                                  <!-- <v-col>
                      ...
                      <h3 class="font-weight-light" v-html="loading ? 'Start to begin' : currentQuestion.question"
