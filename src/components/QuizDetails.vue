        ...
        <div v-if="currentHisto">
            ...
            <div v-show="admin">
                <div class="d-flex justify-space-around w-100 mb-3">
                    <v-btn type="submit" color="blue" @click="updateTutorial" variant="outlined">Update</v-btn>
                    
                    <v-btn type="submit" color="red" @click="deleteTutorial" variant="outlined">Delete</v-btn>
                </div>
            </div>
        </div>
    </div>
